...
def write():
    ...
    def load_preprocess_data():
        ...
        test = pd.read_csv('/home/ada/stuff/streamlit 101/sales/test.csv', na_values=na_value)
        store = pd.read_csv('/home/ada/stuff/streamlit 101/sales/store.csv', na_values=na_value)
        submission = pd.read_csv('/home/ada/stuff/streamlit 101/sales/sample_submission.csv', na_values=na_value)
